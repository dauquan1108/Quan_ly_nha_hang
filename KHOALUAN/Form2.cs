...
namespace KHOALUAN
{
    public partial class Form2 : Form
    {
        ...
        public void LOAT()
        {
            ...
            string sql = "  SELECT ID,TenQuyen,HoTenNV,QUYEN.IDQuyen,TAIKHOAN.IDTaiKhoan FROM dbo.QUYENTAIKHOAN, dbo.QUYEN, dbo.NHANVIEN,dbo.TAIKHOAN WHERE NHANVIEN.IDNhanVien = TAIKHOAN.IDNhanVien AND TAIKHOAN.IDTaiKhoan = QUYENTAIKHOAN.IDTaiKhoan AND QUYEN.IDQuyen = QUYENTAIKHOAN.IDQuyen";
        ...
        private void BTN_THEM_Click(object sender, EventArgs e)
        {
            ...
            {               
                if (ID_QUYEN.Text == "")
                {
                    THONG_BAO.Text = "Vui lòng chọn !";
                    THONG_BAO.ForeColor = Color.Red;
                }
                if (ID_TAI_KHOAN.Text == "")
                {
                    THONG_BAO1.Text = "Vui lòng chọn !";
        ...
        private void ID_QUYEN_Click(object sender, EventArgs e)
        {
           
        }

        private void ID_TAI_KHOAN_Click(object sender, EventArgs e)
        {
        ...
        private void dataGridView2_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                ID_QUYEN.Text = row.Cells[1].Value.ToString();
                ID_TAI_KHOAN.Text = row.Cells[2].Value.ToString();
            }
        }
        ...
        private void ID_TAI_KHOAN_MouseClick(object sender, MouseEventArgs e)
        {
           
        }

        private void ID_TAI_KHOAN_MouseDoubleClick(object sender, MouseEventArgs e)
        {

        }

        private void ID_TAI_KHOAN_MouseCaptureChanged(object sender, EventArgs e)
        {
        ...
        private void ID_TAI_KHOAN_DropDown(object sender, EventArgs e)
        {
            ...
            conn = new SqlConnection(conString);
            conn.Open(); //Mở kết nối.
            string sql = "SELECT IDTaiKhoan,HoTenNV FROM dbo.NHANVIEN, dbo.TAIKHOAN WHERE NHANVIEN.IDNhanVien = TAIKHOAN.IDNhanVien";
            SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            DataTable dt = new DataTable();
            da.Fill(dt);
            ID_TAI_KHOAN.ValueMember = "IDTaiKhoan";
            ID_TAI_KHOAN.DisplayMember = "HoTenNV";
            ID_TAI_KHOAN.DataSource = dt;
            conn.Close();
        }

        private void ID_QUYEN_SelectedIndexChanged(object sender, EventArgs e)
        {
            THONG_BAO.Text = "";
        }

        private void ID_TAI_KHOAN_SelectedIndexChanged(object sender, EventArgs e)
        {
            THONG_BAO1.Text = "";
        }
